...
{
    [Guid("2a6a80c4-ac7c-4ba0-9552-5fccfbf00366")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": ShrinkWrapPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": ShrinkWrapPlugin: deactivating... ");
